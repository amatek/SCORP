/**
 * RoutingDecisionRouter.java was adapted to cope with SCORP.
 * 
...
public interface RoutingDecisionEngine
{
	 ...
	 * otherwise.
	 */
	public boolean isFinalDest(Message m, DTNHost aHost, boolean otherHostIsFinal); 
	 ...
	 * @param thisHost Host who sent the message
