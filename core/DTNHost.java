/* 
 * DTNHost.java was adapted to cope with SCORP.
 * 
...
public class DTNHost implements Comparable<DTNHost> {
	...
	/** Host's list of interests - for SCORP **/
	private List<String> hostInterests;
	...
	/**
	 * Creates a new DTNHost  for SCORP 
	 * @param msgLs Message listeners
	 * @param movLs Movement listeners
	 * @param hInt List of interests
	 * @param groupId GroupID of this host
	 * @param interf List of NetworkInterfaces for the class
	 * @param comBus Module communication bus object
	 * @param mmProto Prototype of the movement model of this host
	 ...
	 */
	public DTNHost(List<MessageListener> msgLs,
			List<MovementListener> movLs, List<String> hInt,
			String groupId, List<NetworkInterface> interf,
			ModuleCommunicationBus comBus, 
			MovementModel mmProto, MessageRouter mRouterProto) {
		this.comBus = comBus;
		...
		/** 		 * for SCORP  		 */
		this.hostInterests = new ArrayList<String>();
		for (String i : hInt) {
			hostInterests.add(i);
		}
		/** 		 * for SCORP  		 */
	...
	/** get host's list of interests - for SCORP **/
	public List<String> getInterests() {
		// TODO Auto-generated method stub
		return this.hostInterests;
	}
